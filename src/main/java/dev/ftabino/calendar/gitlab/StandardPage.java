 ...
 */
final class StandardPage<T> implements Page<T> {
    ...
    /**
     * Creates a new {@code StandardPage} that has the given {@code content}.
     * The page was retrieved from the given {@code url} and has the given {@code etag}.
     * The given {@code nextSupplier} will be used to obtain the next page {@link #next when requested}.
     *
