...
package dev.ftabino.calendar.test;
...
/**
 * A {@link TestExecutionListener} that enables the usage of {@link TestMethodResponseCreator}.
 *
...
public final class TestMethodResponseTestExecutionListener extends AbstractTestExecutionListener {
    ...
    public void beforeTestClass(TestContext testContext) {
        ((ConfigurableBeanFactory) testContext.getApplicationContext().getAutowireCapableBeanFactory())
                .registerSingleton("testMethodResponseCreator", testMethodResponseCreator);
    }

    @Override
    public void beforeTestMethod(TestContext testContext) {
        testMethodResponseCreator.setTest(testContext.getTestClass(), testContext.getTestMethod());
    }
